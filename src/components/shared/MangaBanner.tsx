                ...
                <div className="absolute-center absolute bottom-1 right-10 z-50 flex h-fit w-fit flex-col space-y-4 lg:bottom-10">
                    {matchesTablet && (
                        <>
                            <SwiperButton
                                type="prev"
                                styleButton="transition-all absolute-center z-[300] md:h-16 md:w-16 w-14 h-14 rounded-full text-black bg-white hover:bg-primary"
                                styleIcon="h-10 w-10"
                            />
                            <SwiperButton
                                type="next"
                    ...
                    <Link href="/justTest">
                        <a>
                            ...
                            <SwiperCard
                                ...
                                childStyle="magictime vanishIn h-full w-[90%]  overflow-hidden rounded-2xl"
                            />
